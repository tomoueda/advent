...
...$.*....
.664.598.."""
actual = """........936..672.........846.922........359...332......582..856........................579..93......674..740.....243.156....................
...........%.........4=...*...*........*.......*......#....................806..481.........................*.......*.........900......$564.
...
symbols = set()
hasher = defaultdict(lambda: None)
...
dir = [(-1, -1), (-1, 0), (1, 0), (0, 1), (0, -1), (1, 1), (-1, 1), (1, -1)]

look = []

reverse_look = defaultdict(lambda: None)
...
for i in range(row_len):
    ...
    for j in range(col_len):
        c = lines[i][j]
        if not c.isdigit()  and digit != '':
            look.append((digit, list(coords)))
            for c in actual_coords:
                reverse_look[c] = (digit, actual_coords)
            digit = ''
            coords = set() 
            actual_coords = set()
        elif c.isdigit():
            for d in dir:
                x = i + d[1]
                y = j + d[0]
                if hasher[(y, x)] is not None:
                    coords.add((y, x))
            digit += c 
            actual_coords.add((j, i))
    if digit != '':
        look.append((digit, list(coords)))
        for c in actual_coords:
            reverse_look[c] = (digit, actual_coords)
    ...
    for j in range(col_len):
        ...
        if c == '*':
            ...
            for d in dir:
                ...
                y = j + d[0]
                r = reverse_look[y, x]
                if (y, x) not in seen and r is not None:
                    item.append(r[0])
                    seen.update(r[1])
            if len(item) == 2:
